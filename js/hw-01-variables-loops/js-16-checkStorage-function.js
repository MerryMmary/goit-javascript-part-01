...
и возвращает сообщение о результате. Она объявляет два параметра, 
...
console.log('checkStorage Is enought goods?', checkStorage(300, 200));
console.log('checkStorage Is enought goods?', checkStorage(300,500));
...
console.log('checkStorage Are enought goods?', checkStorage(300, 200));
console.log('checkStorage Are enought goods?', checkStorage(200, 300));
console.log('checkStorage Are enought goods?', checkStorage(200,0));
...
const getTotalBalanceByGender = (users, gender) => {
    return [...users].filter(user => user.gender === gender) // масив обєктів з вказаною статтю
    .reduce((acc, user) => acc + user.balance, 0); // сума балансів user-ів
};
// Пиши код выше этой строки

console.log('44- ', getTotalBalanceByGender([
  {
    name: 'Moore Hensley',
    email: 'moorehensley@indexia.com',
    eyeColor: 'blue',

...
const getFriends = (users) => {
  ...
  //   { const currentUserFiends=user.friends;
  //   console.log('currentUserFiends', currentUserFiends);
  //   return currentUserFiends;

  // const allFriends = [];
  // for (let i = 0; (i < userFriends.length); i+=1) {
  //   if (userFriends[i] === i) {
  //     allFriends.push(userFriends[i]);
  //   }
  // }
...
console.log('21- getFriends', getFriends([
  {
    name: 'Moore Hensley',
    email: 'moorehensley@indexia.com',
    eyeColor: 'blue',

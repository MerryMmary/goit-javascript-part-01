/*
Задача: проверка пароля / ternary operator
...
console.log('checkPassword /ternary operator/ is verify?', checkPassword(202020));
console.log('checkPassword /ternary operator/ is verify?', checkPassword('jqueryismyjam'));